...
initMoviesModule() async {
  if (!GetIt.I.isRegistered<GetArticlesUseCase>()) {
    //GetMoviesUseCase instance
    instance.registerFactory<GetArticlesUseCase>(
        () => GetArticlesUseCase(instance()));
    //MoviesViewModel instance
    instance.registerFactory<HomeArticlesViewModel>(
        () => HomeArticlesViewModel(instance(), instance()));
  }
}
